const recipes = [
  ...
  },
  {
    name: "سمك قاروص مشوي",
    isVisible: true,
    image: "images/qorous.png",
    desc: "سمك قاروص على الفحم 🇪🇬",
    ingredients: ["قاروص", "ثوم", "كمون", "كزبرة", "ليمون", "فلفل أخضر"],
    steps: [
      "نظفي القاروص وأحدثي فيه شقوقاً عميقة",
      "احشي الشقوق بالثوم والبهارات",
      "ادهنيه بخليط الليمون والكمون",
      "اتركيه يتتبل ساعة",
      "اشويه على الفحم وقدمي مع الطحينة"
    ],
    time: "70 دقيقة",
    level: "متوسط",
    price: "غالي"
  },
  {
    name: "برنيوف",
    isVisible: true,
    image: "images/barniof.png",
    desc: "حلوى الدقيق بالسمن 🇪🇬",
    ingredients: ["دقيق", "سمن", "عسل", "قرفة", "ينسون"],
    steps: [
      "قلي الدقيق في السمن حتى يحمر",
      "أضيفي القرفة والينسون",
      "حركي باستمرار على نار هادئة",
      "أضيفي العسل",
      "قدمي فاتراً"
    ],
    time: "20 دقيقة",
